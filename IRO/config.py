...
class Config(object):
    ...
    OWNER_ID = 6608713615  # got to @Iro_m_bot and type /id
    OWNER_USERNAME = "PB65_Aujla" # your telegram username
    ALLOW_CHATS = True # leave it as it is
    BOT_USERNAME = "MissSardarniBot" # your bot username get it form @botfather
    SUPPORT_CHAT = "The_ChatGroup"  # Your own group for support, do not add the @ if you dont have leave it as it is
    UPDATES_CHANNEL = "The_Support_World"  # Your own chsnnel for support, do not add the @ if you dont have leave it as it is
    JOIN_LOGGER =  (
        -1002056154003
    ...
    SPAMWATCH_SUPPORT_CHAT = "@The_ChatGroup"
    ...
    DEV_USERS = [6608713615]
    ##List of id's (not usernames) for users which are allowed to gban, but can also be banned.
    DEMONS = [6608713615]
    # List of id's (not usernames) for users which WONT be banned/kicked by the bot.
    TIGERS = [6608713615]
    WOLVES = [6608713615]
    START_IMG = "https://graph.org/file/8a4a62d3a2d956d43d117.jpg" #yor fav img link
    CERT_PATH = None
    PORT = 5000
